   ...
   <main>
      ...
      <table class="data">
         ...
         <tr>
            ...
            <td>8.2+</td>
            <td><?php echo (phpversion() >= '8.2') ? '<img src="images/yes.svg" alt="Good" class="image" />' : '<img src="images/no.svg" class="image" alt="Bad" />'; ?></td>
         </tr>
         <tr>
      ...
      <p
        class="info">These settings are recommended for PHP in order to ensure full compatibility with Membership Manager Pro.
      ...
      <p
        class="info">In order for Membership Manager Pro to function correctly it needs to be able to access or write to certain files or directories. If you see "Unwritable" you need to change the permissions on the file or directory to allow Membership Manager Pro to write to it. </p>
      <div class="divider"></div>
      <table class="data">
...
<footer><small>current <b>Membership Manager Pro v.5.0</b></small>
   <div id="buttons">
