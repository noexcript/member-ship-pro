   ...
   <div class="center-align">
      ...
      <div class="margin-small-top">
         <p class="wojo small icon alert inverted attached compact message">
            ...
            <?php echo Language::$word->MEM_NOMEM; ?>
         </p>
      </div>
   </div>
<?php else : ?>
            ...
            <div class="footer">
               <div class="row small-horizontal-gutters justify-center">
                  <div class="columns auto">
                     <a href="<?php echo Url::url(Router::$path, 'edit/' . $row->id); ?>" class="wojo icon inverted primary button">
                        <i class="icon pencil"></i>
                     </a>
                  </div>
                  <div class="columns auto">
                     <a data-set='{"option":[{"action": "trashMembership","title": "<?php echo Validator::sanitize($row->title, 'chars'); ?>","id": <?php echo $row->id; ?>}],"action":"trash","parent":"#item_<?php echo $row->id; ?>"}' class="wojo icon inverted negative button data">
