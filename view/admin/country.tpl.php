         ...
         <div class="center-align">
            ...
            <div class="margin-small-top">
               <p class="wojo small icon alert inverted attached compact message">
                  <i class="icon exclamation triangle"></i><?php echo Language::$word->CNT_NOCOUNTRY; ?>
               </p>
            </div>
         </div>
      <?php else : ?>
            ...
            <table class="wojo basic responsive table" id="editable">
               ...
               <?php foreach ($this->data as $row) : ?>
                  <tr id="item_<?php echo $row->id; ?>">
                     ...
                     <td class="auto">
                        <a href="<?php echo Url::url(Router::$path, 'edit/' . $row->id); ?>" class="wojo icon circular primary inverted button">
