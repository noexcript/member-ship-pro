...
<footer>
   <p class="icon-text"><i class="icon wojologo"></i>Copyright &copy;<?php echo date('Y') . ' ' . $this->core->company; ?> | Powered by <small> [wojo::works]v.<?php echo $this->core->wojov; ?></small></p>
</footer>
