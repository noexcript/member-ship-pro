...
if (is_dir(BASEPATH . 'setup')) : die("<div style='text-align:center'>"
      ...
      <div id="formContent">
         ...
         <div id="loginform">
            <form id="admin_form" name="admin_form" method="post">
               ...
               <button id="doSubmit" type="button" name="submit" class="fadeIn fourth"><?php echo Language::$word->LOGIN; ?></button>
            </form>
         ...
         <div id="passform" class="hide-all">
            <input type="text" name="pEmail" id="pEmail" class="input-container" placeholder="<?php echo Language::$word->M_EMAIL; ?>">
