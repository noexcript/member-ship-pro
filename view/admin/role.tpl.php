         ...
         <?php foreach ($this->data as $row) : ?>
            <div class="card">
               ...
               <div class="footer divided center-align">
                  <a href="<?php echo Url::url(Router::$path, 'edit/' . $row->id); ?>" class="wojo icon inverted negative button spaced">
                     <i class="icon lock"></i>
                  </a>
                  <a data-set='{"option":[{"action":"editRole","id": <?php echo $row->id; ?>}], "label":"<?php echo Language::$word->UPDATE; ?>", "url":"helper.php", "parent":"#item_<?php echo $row->id; ?>", "complete":"replace", "modalclass":"normal"}' class="wojo icon primary inverted button action">
