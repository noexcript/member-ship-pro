   ...
   <div class="center-align">
      ...
      <div class="margin-small-top">
         <p class="wojo small icon alert inverted attached compact message">
            <i class="icon exclamation triangle"></i><?php echo Language::$word->TRS_NOTRS; ?>
         </p>
      </div>
   </div>
<?php else : ?>
            ...
            <div class="wojo simple segment margin-bottom">
               <table class="wojo small basic table">
                  <thead>
                     <tr>
                        <th colspan="2">
                           <h6><?php echo Language::$word->ADM_USERS; ?></h6>
                        </th>
                     </tr>
                  </thead>
                  <?php foreach ($rows as $row) : ?>
                     ...
                     <tr id="user_<?php echo $dataset->id; ?>">
                        ...
                        <td class="auto">
                           <a data-set='{"option":[{"restore": "restoreUser","title": "<?php echo Validator::sanitize($dataset->fname . ' ' . $dataset->lname, 'chars'); ?>","id": "<?php echo $row->id; ?>", "type":"user"}],"action":"restore","subtext":"<?php echo Validator::sanitize(
                                                                                                                                                                                                                                                               Language::$word->DELCONFIRM11,
                                                                                                                                                                                                                                                               'chars'
                                                                                                                                                                                                                                                            ); ?>", "parent":"#user_<?php echo $dataset->id; ?>"}' class="wojo mini positive button data">
            ...
            <div class="wojo simple segment margin-bottom">
               <table class="wojo small basic table">
                  <thead>
                     <tr>
                        <th colspan="2">
                           <h6><?php echo Language::$word->ADM_MEMBS; ?></h6>
                        </th>
                     </tr>
                  </thead>
                  <?php foreach ($rows as $row) : ?>
                     ...
                     <tr id="membership_<?php echo $dataset->id; ?>">
                        ...
                        <td class="auto">
                           <a data-set='{"option":[{"restore": "restoreMembership","title": "<?php echo Validator::sanitize($dataset->title, 'chars'); ?>","id": "<?php echo $row->id; ?>", "type":"membership"}],"action":"restore","subtext":"<?php echo Validator::sanitize(
                                                                                                                                                                                                                                                   Language::$word->DELCONFIRM11,
                                                                                                                                                                                                                                                   'chars'
                                                                                                                                                                                                                                                ); ?>", "parent":"#membership_<?php echo $dataset->id; ?>"}' class="wojo mini positive button data">
                              <?php echo Language::$word->RESTORE; ?>
                           </a>
            ...
            <div class="wojo simple segment margin-bottom">
               <table class="wojo small basic table">
                  <thead>
                     <tr>
                        <th colspan="2">
                           <h6><?php echo Language::$word->ADM_PAGES; ?></h6>
                        </th>
                     </tr>
                  </thead>
                  <?php foreach ($rows as $row) : ?>
            ...
            <div class="wojo simple segment margin-bottom">
               <table class="wojo small basic table">
                  <thead>
                     <tr>
                        <th colspan="2">
                           <h6><?php echo Language::$word->ADM_COUPONS; ?></h6>
                        </th>
                     </tr>
                  </thead>
                  <?php foreach ($rows as $row) : ?>
            ...
            <div class="wojo simple segment margin-bottom">
               <table class="wojo small basic table">
                  <thead>
                     <tr>
                        <th colspan="2">
                           <h6><?php echo Language::$word->ADM_NEWS; ?></h6>
                        </th>
                     </tr>
                  </thead>
                  <?php foreach ($rows as $row) : ?>
