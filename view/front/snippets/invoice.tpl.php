   ...
   <table border="0">
      <tr>
         ...
         <td valign="top" style="width:40%;text-align: right">
            <h4 style="margin:0;padding:0;font-size: 12px;">Invoice: #<?php echo $this->row->invid; ?></h4>
            <h4 style="margin:0;padding:0;font-size: 12px;"><?php echo Date::doDate('short_date', $this->row->created); ?></h4>
         </td>
      </tr>
   </table>
   ...
   <table style="padding-top:25px">
      ...
      <tr>
         <td valign="top" style="width:60%">
            <p><?php echo Validator::cleanOut($this->core->inv_info); ?></p>
         </td>
         <td colspan="2" valign="top" style="width:40%">
            <p><?php echo $this->user->fname; ?> <?php echo $this->user->lname; ?><br />
               <?php echo $this->user->address; ?><br />
               <?php echo $this->user->city . ', ' . $this->user->state . ' ' . $this->user->zip; ?><br />
               <?php echo $this->user->country; ?></p>
         </td>
      </tr>
      <tr>
         <td valign="top" style="width:60%"><br /></td>
         <td valign="top" style="width:20%">Amount Due:<br /> Due Date:</td>
